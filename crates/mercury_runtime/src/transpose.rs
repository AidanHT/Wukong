...
#[no_mangle]
pub unsafe extern "C" fn mercury_transpose_u16(src: *const u16, dst: *mut u16, rows: i64, cols: i64) {
    if rows <= 0 || cols <= 0 {
        return;
    }
    transpose_rows(src, dst, rows as usize, cols as usize, 0, rows as usize);
...
///
/// # Safety
/// Operand-size contract of [`mercury_transpose_u16`].
#[no_mangle]
pub unsafe extern "C" fn mercury_transpose_u16_parallel(
    src: *const u16,
    dst: *mut u16,
    rows: i64,
    cols: i64,
...
mod tests {
    ...
    fn transpose_u16_matches_naive_and_parallel() {
        for (r, c) in [
            ...
            unsafe {
                mercury_transpose_u16(src.as_ptr(), got.as_mut_ptr(), r as i64, c as i64);
                mercury_transpose_u16_parallel(src.as_ptr(), got_par.as_mut_ptr(), r as i64, c as i64);
            }
