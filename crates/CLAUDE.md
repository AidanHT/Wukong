...
- `mercury_driver` -> `mercury_span`, `mercury_diag`, `mercury_lexer`, `mercury_ast`, `mercury_parser`, `mercury_sema`, `mercury_mir`, `mercury_mir_build`, `mercury_backend`, `mercury_interp`, `mercury_opt`, `mercury_codegen_llvm`.
